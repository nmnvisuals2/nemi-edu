...
function ContactForm(props){
 ...
 {!props.special ?<h2>{props.heading}</h2> : '' }
        ...
        {!props.special ? <textarea name='name' placeholder="Write a message...." onChange={(e)=>setMessage(e.target.value)}></textarea>: ''}
        <a onClick={(e)=>{e.preventDefault(),props.handleSubmitForm(fullName,email,phone,message)}}>{!props.special ? 'SUBMIT' : 'Enquire Now'}</a>
